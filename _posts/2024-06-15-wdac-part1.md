...
A quick and easy test is to go and download Google Chrome to see if it runs. If all has gone to plan, then you should get a big error saying that ACfB has blocked the file from running. If you do, Congratulations! Best move on to [Part 2]({% post_url 2024-06-16-wdac-part2 %}).